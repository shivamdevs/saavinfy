 ...
 *
 * @example
 * <LucideSearch color="green" size={29} />
 *
...
const LucideSearch: LucideElement = React.forwardRef<SVGSVGElement, LucideProps>(({ className, color, size, ...props }, ref) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size ?? 20} height={size ?? 20} viewBox="0 0 24 24" fill="none" stroke={color ?? "currentColor"} strokeWidth={2.25} strokeLinecap="round" strokeLinejoin="round" {...props} className={`lucide lucide-search${className ? ` ${className}` : ""}`} ref={ref}><circle cx="11" cy="11" r="8" /><path d="m21 21-4.3-4.3" /></svg>
));

LucideSearch.displayName = "LucideSearch";
