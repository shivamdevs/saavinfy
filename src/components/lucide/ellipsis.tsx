 ...
 * @returns {React.Component} LucideEllipsis component
 *
 * @example
 * <LucideEllipsis color="blue" size={25} />
 *
 * @see https://lucide.dev/icons/ellipsis
 */
const LucideEllipsis: LucideElement = React.forwardRef<SVGSVGElement, LucideProps>(({ className, color, size, ...props }, ref) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size ?? 20} height={size ?? 20} viewBox="0 0 24 24" fill="none" stroke={color ?? "currentColor"} strokeWidth={2.25} strokeLinecap="round" strokeLinejoin="round" {...props} className={`lucide lucide-ellipsis${className ? ` ${className}` : ""}`} ref={ref}><circle cx="12" cy="12" r="1" /><circle cx="19" cy="12" r="1" /><circle cx="5" cy="12" r="1" /></svg>
));

LucideEllipsis.displayName = "LucideEllipsis";

export default LucideEllipsis;
